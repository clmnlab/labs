function regressor = extract_AM_Regressor(sub_idn,session_n,total_n,day_n,EL)
    subjdata0=load_IFsession(sub_idn,total_n,day_n);
    switch EL
        case 'E'
            sessions=subjdata0{1};
        case 'L'
            sessions=subjdata0{7};
    end
    inputsession=sessions{session_n};
    real_time=inputsession.start_wait;
    input_M2=inputsession.learn2nd;
    input_M1=inputsession.learn1st;
