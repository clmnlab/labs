function regressor=extract_IFregressor(sub_idn,day_n,session_n,exdays,total_n)
    subj_data=load_IFsession(sub_idn,total_n,exdays);
    inputsession=subj_data{day_n}{session_n};
    real_time=inputsession.start_wait;
    input_1st=inputsession.learn1st;
    input_2nd=inputsession.learn2nd;
