function write_Reward(subj_idn, total_n)
    ...
    subj=extractResult(subj_idn,total_n);
    for i = 1:total_n
        leftReward_file_name=strcat(result_dir,'/leftHit_run0',num2str(i),'.txt');
        rightReward_file_name=strcat(result_dir,'/rightHit_run0',num2str(i),'.txt');
        totalReward_file_name=strcat(result_dir,'/totalHit_run0',num2str(i),'.txt');
