function write_Hit(subj_idn, total_n)
    if subj_idn < 10 
        if exist(strcat('reward/G7T_TR0',num2str(subj_idn)),'dir')==0
            mkdir(strcat('reward/G7T_TR0',num2str(subj_idn)))
        end
        result_dir=strcat('reward/G7T_TR0',num2str(subj_idn));
        total_dir=strcat('regressor/G7T_TR0',num2str(subj_idn));
    else
        if exist(strcat('reward/G7T_TR',num2str(subj_idn)),'dir')==0
            mkdir(strcat('reward/G7T_TR',num2str(subj_idn)))
        end
        result_dir=strcat('reward/G7T_TR',num2str(subj_idn));
        total_dir=strcat('regressor/G7T_TR',num2str(subj_idn));
    end
    
    subj=extractHit(subj_idn,total_n);
    for i = 1:total_n
        ...
        totalReward_file_name=strcat(total_dir,'/totalReward_run0',num2str(i),'.txt');
