function [rewardRT_mat,rewardRTyoked_mat,onset_time,onset_time_yoked,inputStim,inputStim_yoked]=extractRegressor_yokederror(ID_n,total_n,session_n)
    folname='main_ex';
    ...
    inputFix_yoked=inputsession.yoked.fixtime_yoked;
