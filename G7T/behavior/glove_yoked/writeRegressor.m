function writeRegressor(id_n,total_n)
    ...
    [a,b,c,d,e,f]=extractRegressor(id_n,total_n,1);
    ...
    for i =2:total_n
        [a,b,c,d,e,f]=extractRegressor(id_n,total_n,i);
    ...
    for i3 = 1:total_n
        [a2,b2,c2,d2,e2,f2]=extractRegressor(id_n,total_n,i3);
